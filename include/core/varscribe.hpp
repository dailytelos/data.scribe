...
ACTION update(name signor, name scope, name varname, vector<string> header, vector<string> operation, uint8_t index, vector<uint128_t> uval, vector<string> sval, vector<int128_t> nval, vector<asset> aval);
...
void _update(name signor, name scope, name varname, vector<string> header, vector<string> operation, uint8_t index, vector<uint128_t> uval, vector<string> sval, vector<int128_t> nval, vector<asset> aval);
